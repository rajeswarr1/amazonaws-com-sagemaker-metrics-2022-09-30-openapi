# Amazon SageMaker Metrics Service MCP Server

This MCP (Model Content Protocol) server provides access to Amazon SageMaker Metrics Service API functionality through HTTP, HTTPS, and STDIO transport modes.
